...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		products.add(new Product(true, "Imported Box of Chocolates1", 10.00,
				true));
		products.add(new Product(false, "Imported Bottle of Perfume1", 47.50,
				true));
		products.add(new Product(false, "Imported Bottle of Perfume2", 27.99,
				true));
		...
		products.add(new Product(true, "Box of Imported Chocolates2", 11.25,
				true));
